...
function FormData() {
    ...
    const [changecolor4, setChangecolor4] = useState({ borderColor: "", borderWidth: "0px", borderStyle: "solid" }); 
   ...
   function validatepassword(value) {
    ...
    function submitfrom(e) {
        ...
        const isValid =
            answer1 === "Name is valid" &&
            answer2 === "E-mail is valid" &&
            answer3 === "Phone number is valid" &&
            answer4 === "pass word is valid" && 
            answer5 === "Gender is valid";
        ...
        if (isValid) {
            ...
            setChangecolor({ borderColor: "", borderWidth: "2px", borderStyle: "solid" });
            setChangecolor1({ borderColor: "", borderWidth: "2px", borderStyle: "solid" });
            setChangecolor2({ borderColor: "", borderWidth: "2px", borderStyle: "solid" });
            setChangecolor3({ borderColor: "", borderWidth: "2px", borderStyle: "solid" });
            setChangecolor4({ borderColor: "", borderWidth: "0px", borderStyle: "solid" });
